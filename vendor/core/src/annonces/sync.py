...
def trigger_public_sync():
    ...
    après le request_finished de la vue qui vient de modifier/supprimer une
    annonce publiée — pour qu'elle disparaisse/se mette à jour sur le
    marketplace sans attendre la prochaine validation admin.
