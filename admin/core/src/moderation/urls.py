...
urlpatterns = [
    ...
    path('vendeurs/<int:pk>/verification/', views.VendeurVerificationDetailView.as_view(), name='vendeur_verification'),
    path('vendeurs/<int:pk>/verification/valider/', views.VendeurValiderEntrepriseView.as_view(), name='vendeur_verification_valider'),
    path('vendeurs/<int:pk>/verification/refuser/', views.VendeurRefuserEntrepriseView.as_view(), name='vendeur_verification_refuser'),
